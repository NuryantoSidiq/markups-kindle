...
lyr_Centroids_1.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'METADATA': 'METADATA', 'SRS_ID': 'SRS_ID', 'WADMKC': 'WADMKC', 'WADMKK': 'WADMKK', 'WADMPR': 'WADMPR', 'UUPP': 'UUPP', });
...
lyr_Centroids_1.set('fieldImages', {'OBJECTID': 'TextEdit', 'METADATA': 'TextEdit', 'SRS_ID': 'TextEdit', 'WADMKC': 'TextEdit', 'WADMKK': 'TextEdit', 'WADMPR': 'TextEdit', 'UUPP': 'TextEdit', });
...
lyr_Centroids_1.set('fieldLabels', {'OBJECTID': 'header label', 'METADATA': 'header label', 'SRS_ID': 'header label', 'WADMKC': 'header label', 'WADMKK': 'header label', 'WADMPR': 'header label', 'UUPP': 'header label', });
